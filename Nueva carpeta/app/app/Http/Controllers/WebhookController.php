...
class WebhookController extends Controller
{
    public function handle(Request $request)
    {
        ...
        // ======================================================
        // 5. SISTEMA DE BUFFERING (DEBOUNCE) - HUMANIZADO
        // ======================================================
        ...
        // 5b. El estado "escribiendo" se enviará desde el Job para mantenerlo activo
        // NO enviamos composing aquí para evitar que desaparezca antes de la respuesta

        // 5c. Delay VARIABLE según tipo de mensaje (simula tiempo de lectura humano)
        ...
        if ($mediaType === 'audio' || $mediaType === 'image') {
            ...
            $randomDelay = rand(1, 3);   // Texto corto: 1-3 segundos
        }

        Log::info("Mensaje buffered con delay de {$randomDelay}s para {$remoteJid}");
